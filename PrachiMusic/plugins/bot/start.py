...
from PrachiMusic.utilities.config import OWNER_ID
from PrachiMusic.utilities.strings import get_command, get_string
from PrachiMusic import Telegram, YouTube, bot
from PrachiMusic.misc import SUDOERS, _boot_
from PrachiMusic.plugins.play.playlist import del_plist_msg
from PrachiMusic.plugins.sudo.sudoers import sudoers_list
from PrachiMusic.modules.main.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from PrachiMusic.modules.main.decorators.language import LanguageStart
from PrachiMusic.modules.utils.formatters import get_readable_time
from PrachiMusic.utilities.inline.help import help_pannel
from PrachiMusic.utilities.inline.start import (private_panel,
                                     start_pannel)
                ...
                [
                    [
                        InlineKeyboardButton(
                            text="• Aʙᴏᴜᴛ Oᴡɴᴇʀ •", url=f"{https://t.me/About_Ranavanshi_Divy}"
                        ),
                        InlineKeyboardButton(
