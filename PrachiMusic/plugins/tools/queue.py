...
from PrachiMusic.modules.main.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from PrachiMusic.modules.main.decorators.language import language, languageCB
from PrachiMusic.utilities.inline import queue_back_markup, queue_markup
...
@bot.on_callback_query(filters.regex("GetTimer") & ~BANNED_USERS)
...
@bot.on_callback_query(filters.regex("GetQueued") & ~BANNED_USERS)
@languageCB
