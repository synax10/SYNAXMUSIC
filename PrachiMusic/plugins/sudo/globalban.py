...
from PrachiMusic.modules.main.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
...
@bot.on_message(filters.command(GBAN_COMMAND) & SUDOERS)
@language
...
@bot.on_message(filters.command(UNGBAN_COMMAND) & SUDOERS)
@language
...
@bot.on_message(filters.command(GBANNED_COMMAND) & SUDOERS)
@language
