...
from PrachiMusic.misc import HAPP, SUDOERS, XCB
from PrachiMusic.modules.main.database import (get_active_chats,
                                       remove_active_chat,
...
@bot.on_message(filters.command(GETLOG_COMMAND) & SUDOERS)
@language
...
@bot.on_message(filters.command(GETVAR_COMMAND) & SUDOERS)
@language
...
@bot.on_message(filters.command(DELVAR_COMMAND) & SUDOERS)
@language
...
@bot.on_message(filters.command(SETVAR_COMMAND) & SUDOERS)
@language
...
@bot.on_message(filters.command(USAGE_COMMAND) & SUDOERS)
@language
...
@bot.on_message(filters.command(UPDATE_COMMAND) & SUDOERS)
@language
async def update_(client, message, _):
    ...
    if await is_heroku():
        ...
        os.system(f"kill -9 {os.getpid()} && python3 -m PrachiMusic")
        exit()


@bot.on_message(filters.command(REBOOT_COMMAND) & SUDOERS)
