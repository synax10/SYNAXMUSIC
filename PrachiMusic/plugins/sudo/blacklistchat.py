...
from PrachiMusic.modules.main.database import (blacklist_chat,
                                       blacklisted_chats,
                                       whitelist_chat)
...
@bot.on_message(filters.command(BLACKLISTCHAT_COMMAND) & SUDOERS)
@language
...
@bot.on_message(filters.command(WHITELISTCHAT_COMMAND) & SUDOERS)
@language
