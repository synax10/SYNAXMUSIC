...
from PrachiMusic.utilities.config import BANNED_USERS, MONGO_DB_URL, OWNER_ID, MUSIC_BOT_NAME
from PrachiMusic.utilities.strings import get_command
from PrachiMusic import bot
from PrachiMusic.misc import SUDOERS
from PrachiMusic.modules.main.database import add_sudo, remove_sudo
...
@bot.on_message(filters.command(SUDOUSERS_COMMAND) & ~BANNED_USERS)
@language
