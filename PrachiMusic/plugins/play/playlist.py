...
from PrachiMusic.utilities.config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from PrachiMusic.utilities.strings import get_command
from PrachiMusic import Carbon, YouTube, bot
from PrachiMusic.modules.main.database import (delete_playlist, get_playlist,
                                       get_playlist_names,
                                       save_playlist)
from PrachiMusic.modules.main.decorators.language import language, languageCB
from PrachiMusic.utilities.inline.play import close_keyboard
from PrachiMusic.utilities.inline.playlist import (botplaylist_markup,
                                              get_playlist_markup,
                                              warning_markup)
        ...
        [
            [
                InlineKeyboardButton(
                    text=_["PL_B_6"],
                    url=f"https://t.me/{bot.username}?start=delplaylists",
                ),
            ]
        ]
    )
...
@bot.on_callback_query(filters.regex("play_playlist") & ~BANNED_USERS)
@languageCB
...
@bot.on_callback_query(filters.regex("add_playlist") & ~BANNED_USERS)
@languageCB
...
@bot.on_callback_query(filters.regex("del_playlist") & ~BANNED_USERS)
@languageCB
...
@bot.on_callback_query(filters.regex("home_play") & ~BANNED_USERS)
@languageCB
