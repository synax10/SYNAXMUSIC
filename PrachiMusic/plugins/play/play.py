...
from SankiMusic.utilities.config import BANNED_USERS, lyrical
from SankiMusic.utilities.strings import get_command
from SankiMusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, bot)
from SankiMusic.modules.core.call import Kaal
from SankiMusic.modules.utils.formatters import seconds_to_min, time_to_seconds
from SankiMusic.modules.utils.channelplay import get_channeplayCB
from SankiMusic.modules.main.database import is_video_allowed
from SankiMusic.modules.main.decorators.language import languageCB
from SankiMusic.modules.main.decorators.play import PlayWrapper
from SankiMusic.utilities.events.filters import command
from SankiMusic.modules.utils.formatters import formats
...
async def play_commnd(
    ...
    if not await is_served_user(message.from_user.id):
        await message.reply_text(
            text="ᴇʀʀᴏʀ, ʏᴏᴜ'ʀᴇ ɴᴏᴛ ᴀ ᴠᴇʀɪғɪᴇᴅ ᴜsᴇʀ.\nᴘʟᴇᴀsᴇ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴠᴇʀɪғʏ ʏᴏᴜʀsᴇʟғ.⚡️𝐒 𝐘 𝐍 𝐀 𝐗⚡️",
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴠᴇʀɪғʏ⚡️𝐒 𝐘 𝐍 𝐀 𝐗⚡️",
