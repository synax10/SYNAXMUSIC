...
class App(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Chatventure_club")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Chatventure_club")
                await self.one.join_chat("webnet_bot_support")
                await self.one.join_chat("about_ranavanshi_divy")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("chatventure_club")
                await self.one.join_chat("webnet_bot_support")
                await self.one.join_chat("about_ranavanshi_divy")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Chatventure_club")
                await self.one.join_chat("webnet_bot_support")
                await self.one.join_chat("about_ranavanshi_divy")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("chatevnture_club")
                await self.one.join_chat("webnet_bot_support")
                await self.one.join_chat("about_ranavanshi_divy")
            except:
                pass
